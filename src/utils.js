...
export const fmtDSY = k => { const n = normalizeDate(k); const d = new Date(n + 'T00:00:00'); if (isNaN(d)) return k; const dd = String(d.getDate()).padStart(2,'0'); const mmm = d.toLocaleDateString('en-US',{month:'short'}); const yy = String(d.getFullYear()).slice(2); return `${dd} ${mmm}, '${yy}`; };
